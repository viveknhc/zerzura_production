...
export default function PrivateDinnerExperianceNew() {

  const private_dinner_packages = dataPackage.private_dinner;
      ...
      <section className='package-banner'>
        <div className="container">
          <div className="heading-box">
            <h2>Private Dinner Experience</h2>
            <p>
              Keen on a dining experience you won’t soon forget? How about cashing in on a BBQ in your very own exclusive dinner set up in the middle of the desert? Spend time and unwind under the magnificent night sky in one of the most mystical dinners in the desert Dubai has to offer! This experience is perfect if you’re looking for an off-beat activity for the weekend, or are in the UAE for the first time
            </p>
          </div>
          ...
          <div className="content-box">
            <div className="row g-5">
              ...
              {private_dinner_packages.map((item) => (
                <div className="col-xl-6" key={item.id}>
                  <Link to={`/private-dinner-experience/${slugify(item.title)}`} class="card">
                    ...
                    <div className="card-footer">
                      ...
                      <div className="button-row">
                        ...
                        <Link to={`/private-dinner-experience/${slugify(item.title)}`} className='know-more'>
                          <p>Know more</p>
